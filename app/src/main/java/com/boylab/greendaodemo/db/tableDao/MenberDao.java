...
*/
public class MenberDao extends AbstractDao<Member, Long> {
    ...
    private Query<Member> leader_MemberListQuery;
    ...
    public List<Member> _queryLeader_MemberList(Long leaderId) {
        synchronized (this) {
        ...
        Query<Member> query = leader_MemberListQuery.forCurrentThread();
